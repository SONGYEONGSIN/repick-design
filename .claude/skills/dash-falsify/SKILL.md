...
- **하위 레벨 흡수 종결** — L3가 편입될 때 같은 내용의 L1·L2가 함께 닫히지 않으면 잔류 수치가 실제 미해결량을 과대 표시한다(2026-07-31 실측: 27건 → 실제 9건). §1 승인 시 **그 delta가 흡수하는 하위 레벨을 함께 종결**하고, `supersedes`에 편입된 정본 절을 적는다.
