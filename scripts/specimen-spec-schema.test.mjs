...
const BASELINE = [
  ...
  // `v0` 은 2026-08-27 에 `v18` 로 개명됐다 — 같은 작품(Attune)이고, 라우트가 `/` 에서 `/v18` 로
  // 내려갔다. 갤러리가 사이트의 정문을 되찾으면서 한 카탈로그 작품이 `/` 를 차지하던 상태를 끝냈다.
  // BASELINE 은 줄어들지 않는다는 규약이라, 빼지 않고 새 id 로 바꿔 적는다.
  "v18", "v6", "v7", "v8", "v9", "v10",
];
