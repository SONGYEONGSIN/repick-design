export default function LandingCandidateAR2() {
  return (
    <div className="min-h-screen bg-[#0B0B0F] text-white antialiased">
      <header className="sticky top-0 z-20 border-b border-white/10 bg-[#0B0B0F]/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-[1120px] items-center justify-between px-6">
          ...
          <a
            href="#start"
            className="rounded border border-white/20 px-4 py-2 text-sm font-semibold transition-colors hover:bg-white hover:text-black"
          >
            무료로 시작하기
          </a>
        </div>
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-white/10">
          ...
          <div className="relative mx-auto max-w-[1120px] px-6 pt-24 pb-20 md:pt-32 md:pb-28">
            <p className="mb-8 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.25em] text-[#A1A1AA]">
              <span className="inline-block h-1.5 w-1.5 rounded-full bg-[#6E56CF]" />
              AI Recommerce — Round 2 · A
            </p>
            <h1 className="max-w-4xl text-[12vw] font-bold leading-[0.98] tracking-tight sm:text-6xl md:text-7xl lg:text-8xl">
              모두가 지나친 물건,
              <br />
              <span className="italic text-[#A1A1AA]">당신만</span> 알아보다
            </h1>
            <p className="mt-8 max-w-md text-lg font-normal leading-relaxed text-[#A1A1AA] md:text-xl">
              AI가 수십만 개의 중고 물건 중, 당신 취향에 맞는 단 하나를 골라냅니다.
            </p>
          ...
          <div className="mx-auto max-w-[1120px] px-6 py-20 md:py-32">
            <div className="mb-14 flex items-end justify-between gap-6">
              <h2 className="text-3xl font-bold tracking-tight md:text-4xl">
                당신이 <span className="italic text-[#A1A1AA]">다시</span> 고르는 이유
              </h2>
            ...
            <div className="grid grid-cols-1 divide-y divide-white/10 border-t border-white/10 md:grid-cols-3 md:divide-x md:divide-y-0">
              {[
                ...
                <article key={item.n} className="px-0 py-10 first:pt-0 md:px-10 md:py-0 md:first:pl-0">
                  <span className="block text-6xl font-bold leading-none text-[#6E56CF]/20 md:text-7xl">
                    {item.n}
                  </span>
          ...
          <div className="mx-auto max-w-[1120px] px-6 py-20 md:py-32">
            ...
            <div className="grid items-end gap-14 md:grid-cols-2 md:gap-16">
              ...
              <blockquote className="border-l border-white/15 pl-6 md:pl-8">
                <p className="text-xl font-normal italic leading-snug text-white/90 md:text-2xl">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-[1120px] px-6 py-24 text-center md:py-40">
            <h2 className="mx-auto max-w-2xl text-4xl font-bold leading-tight tracking-tight md:text-6xl">
              지금, <span className="italic text-[#A1A1AA]">다시</span> 골라볼 시간
            </h2>
