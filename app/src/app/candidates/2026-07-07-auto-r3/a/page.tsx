        ...
        <div className="mx-auto max-w-[1320px] px-6 py-24 lg:px-10 lg:py-36">
          ...
          <div className="mt-16 grid grid-cols-12 gap-x-6 gap-y-14 lg:mt-24">
            ...
            <div className="col-span-12 border-t border-white/10 pt-6 lg:col-span-4 lg:col-start-6 lg:mt-16">
              <span
                aria-hidden="true"
                className="block text-[clamp(2rem,4.5vw,4rem)] font-extrabold leading-none tracking-[-0.03em] text-white/15"
              >
                02
              </span>
            ...
            <div className="col-span-12 border-t border-white/10 pt-6 lg:col-span-3 lg:col-start-10 lg:mt-32">
              <span
                aria-hidden="true"
                className="block text-[clamp(1.5rem,3.5vw,3rem)] font-extrabold leading-none tracking-[-0.03em] text-white/15"
              >
                03
              </span>
        ...
        <div className="mx-auto max-w-[1320px] px-6 py-24 lg:px-10 lg:py-36">
          ...
          <div className="mt-10 grid grid-cols-12 gap-x-6 gap-y-14">
            <div className="col-span-12 lg:col-span-7">
              <span
                aria-hidden="true"
                className="block text-[clamp(2.5rem,5vw,4rem)] font-extrabold leading-none text-white/15"
              >
                “
              </span>
        ...
        <div className="mx-auto max-w-[1320px] px-6 py-28 lg:px-10 lg:py-40">
          <div className="grid grid-cols-12 items-end gap-x-6 gap-y-10">
            <div className="col-span-12 lg:col-span-2">
              ...
              <p className="mt-2 text-xs font-normal uppercase tracking-[0.16em] text-[#A1A1AA]">
                Fig. 04 — 시작
              </p>
            </div>

            <div className="col-span-12 lg:col-span-9 lg:col-start-4">
              <h2 className="max-w-[20ch] text-[clamp(2.25rem,6vw,5.5rem)] font-extrabold leading-[0.98] tracking-[-0.03em] lg:text-right lg:ml-auto">
                지금, 당신을 위해
                <br />
