    ...
    <div className="min-h-screen bg-[#0B0B0F] text-white antialiased">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0B0B0F]/85 backdrop-blur">
        <div className="mx-auto flex max-w-[1320px] items-center justify-between px-6 py-5 lg:px-10">
          ...
          <nav className="hidden items-center gap-8 text-sm font-normal text-[#A1A1AA] md:flex">
            <a
              href="#value"
              className="rounded-sm transition-colors duration-200 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6E56CF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0B0F]"
            >
              방식
            </a>
            <a
          ...
          <a
            href="#cta"
            className="rounded-full border border-white/15 px-4 py-2 text-xs font-semibold tracking-[0.02em] text-white transition-colors duration-200 hover:border-white/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6E56CF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0B0F]"
          >
            무료로 시작
          </a>
        </div>
      ...
      <section id="hero" className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative z-10 mx-auto grid max-w-[1320px] grid-cols-12 gap-x-6 gap-y-14 px-6 pt-24 pb-28 lg:px-10 lg:pt-32 lg:pb-40">
          <p className="col-span-12 text-xs font-semibold uppercase tracking-[0.28em] text-[#A1A1AA] md:col-span-3 md:col-start-1">
            01 — 소개
            <br className="hidden lg:block" /> AI 리커머스 큐레이션
          </p>

          <h1 className="col-span-12 max-w-[18ch] text-[clamp(1.875rem,9vw,3.5rem)] font-extrabold leading-[0.98] tracking-[-0.03em] md:col-span-9 md:col-start-4 lg:text-[clamp(2.5rem,7vw,6.5rem)] lg:leading-[0.96] lg:tracking-[-0.035em]">
            버려질 뻔한 것들,
            <br />
            <span className="text-[#6E56CF]">다시</span>, 고르다.
          </h1>

          <p className="col-span-12 max-w-[38ch] text-base font-normal leading-[1.6] text-[#A1A1AA] md:col-span-5 md:col-start-1">
            AI가 당신의 취향을 학습해 수많은 중고 상품 중 지금 당신에게 맞는 것만 다시
            골라드립니다.
          </p>

          <div className="col-span-12 flex flex-wrap items-center gap-5 md:col-span-6 md:col-start-7">
            <a
              href="#cta"
              className="rounded-full bg-[#6E56CF] px-7 py-3.5 text-sm font-semibold text-white transition-opacity duration-200 hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6E56CF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0B0F]"
            >
              무료로 시작하기
            </a>
            <a
              href="#value"
              className="rounded-sm text-sm font-semibold text-[#A1A1AA] transition-colors duration-200 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6E56CF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0B0F]"
            >
              색인 보기 →
            </a>
          </div>

          <div className="col-span-12 md:col-span-6 md:col-start-7 lg:col-span-4 lg:col-start-9">
            <div className="grid grid-cols-3 gap-px overflow-hidden rounded-md border border-white/10 bg-white/10">
              {Array.from({ length: 9 }).map((_, i) => (
                <div
                  key={i}
                  className={`aspect-square bg-[#0B0B0F] transition-colors duration-200 ${i === 4 ? "bg-[#6E56CF]" : ""}`}
                />
              ))}
            </div>
      ...
      <section id="value" className="border-b border-white/10">
        <div className="mx-auto max-w-[1320px] px-6 py-24 lg:px-10 lg:py-36">
          <div className="grid grid-cols-12 gap-x-6 gap-y-6">
            <p className="col-span-12 text-xs font-semibold uppercase tracking-[0.28em] text-[#A1A1AA] md:col-span-2">
              02 — 방식
            </p>
            <h2 className="col-span-12 max-w-[20ch] text-[clamp(1.75rem,3.4vw,3rem)] font-extrabold leading-[1.05] tracking-[-0.02em] md:col-span-6 md:col-start-3">
              세 가지 방식으로 다시 고릅니다
            </h2>
            <p className="col-span-12 max-w-[32ch] text-sm font-normal leading-[1.6] text-[#A1A1AA] md:col-span-4 md:col-start-9 lg:col-span-3 lg:col-start-10">
              관심 표현부터 실제 구매, 판매자 신뢰도까지 — 단계별로 검증합니다.
            </p>
          </div>

          <div className="mt-16 grid grid-cols-12 gap-x-6 gap-y-14 lg:mt-24">
            <div className="col-span-12 border-t border-white/10 pt-6 md:col-span-6 lg:col-span-5">
              <span
                aria-hidden="true"
            ...
            <div className="col-span-12 border-t border-white/10 pt-6 md:col-span-6 md:col-start-7 lg:col-span-4 lg:col-start-6 lg:mt-16">
              <span
                aria-hidden="true"
            ...
            <div className="col-span-12 border-t border-white/10 pt-6 md:col-span-12 md:mt-10 lg:col-span-3 lg:col-start-10 lg:mt-32">
              <span
                aria-hidden="true"
      ...
      <section id="proof" className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative z-10 mx-auto max-w-[1320px] px-6 py-24 lg:px-10 lg:py-36">
          ...
          <div className="mt-10 grid grid-cols-12 gap-x-6 gap-y-14">
            ...
            <div className="col-span-12 border-l border-white/10 pl-8 md:col-span-5 md:col-start-8 lg:col-span-4 lg:col-start-9">
              ...
              <div className="mt-8 flex flex-col gap-8">
                {[
                  ...
                  <div key={s.l}>
                    <p className="text-[clamp(1.5rem,2.4vw,2rem)] font-extrabold leading-none tracking-[-0.02em] tabular-nums">
                      {s.v}
                    </p>
      ...
      <section id="cta" className="border-b border-white/10">
        <div className="mx-auto max-w-[1320px] px-6 py-28 lg:px-10 lg:py-40">
          <div className="grid grid-cols-12 items-end gap-x-6 gap-y-10">
            ...
            <div className="col-span-12 md:col-span-10 md:col-start-3 lg:col-span-9 lg:col-start-4">
              ...
              <div className="mt-10 flex flex-col items-start gap-4 lg:items-end">
                <a
                  href="#"
                  className="rounded-full bg-[#6E56CF] px-9 py-4 text-sm font-semibold text-white transition-opacity duration-200 hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6E56CF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0B0F]"
                >
                  무료로 시작하기
                </a>
