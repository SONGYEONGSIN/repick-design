...
const NOTIFICATIONS = [
  { id: "n1", text: "Partner Referral → Enterprise ribbon grew 4.1pp of new MRR this period.", time: "18m ago" },
  { id: "n2", text: "Starter-tier 90-day churn crossed 34% of that tier's signups.", time: "2h ago" },
  { id: "n3", text: "Scale-tier expansion share is up 3.0pp over the last period.", time: "6h ago" },
];
