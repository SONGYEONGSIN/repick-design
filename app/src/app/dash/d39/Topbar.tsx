...
import { Bell, HelpCircle, LogOut, Menu, Search, Settings, UserPlus } from "lucide-react";
...
const NOTIFICATIONS = [
  { id: "n1", text: "Owen Castillo revoked Admin access to “Delete workspace”.", time: "2h ago" },
  { id: "n2", text: "Priya Nakamura granted Editor access to “Manage webhooks”.", time: "5h ago" },
  { id: "n3", text: "Your weekly access review is due — 3 roles unchanged in 30 days.", time: "1d ago" },
];
