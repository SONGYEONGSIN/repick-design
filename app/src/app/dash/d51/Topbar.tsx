...
const NOTIFICATIONS = [
  { id: "n1", text: "Critical: admin impersonation started by elena.cho", time: "2m ago" },
  { id: "n2", text: "5 failed logins from 203.0.113.44, account locked", time: "11m ago" },
  { id: "n3", text: "Weekly audit digest is ready to export", time: "1h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search events, actors&hellip;</span>
