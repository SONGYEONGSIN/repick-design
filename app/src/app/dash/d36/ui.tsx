...
/** Progress/conversion-rate progress bar — track + fill; pairing color with a numeric value is the caller's responsibility. */
...
/** Deterministic mini sparkline — line + subtle area fill + endpoint. Coordinates rounded to 2 decimal places. */
