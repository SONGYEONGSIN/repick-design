...
const NOTIFICATIONS = [
  { id: "n1", text: "Checkout Started → Shipping Info drop-off rose 3.2pp this week.", time: "12m ago" },
  { id: "n2", text: "Direct traffic purchase rate is up 0.6pp over the last period.", time: "1h ago" },
  { id: "n3", text: "Card decline rate crossed 33% of Payment Info drop-offs.", time: "5h ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white dark:bg-zinc-950")}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search stages, segments, reasons</span>
        <span
          aria-hidden="true"
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          {notifOpen ? (
            <div role="menu" aria-label="Notifications" className={cx("absolute right-0 top-full z-40 mt-2 w-80 max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border", BORDER, "bg-white shadow-lg dark:bg-zinc-900")}>
        ...
        <div ref={userRef} className="relative">
          ...
          {userOpen ? (
            <div role="menu" aria-label="Account" className={cx("absolute right-0 top-full z-40 mt-2 w-60 overflow-hidden rounded-xl border p-1", BORDER, "bg-white shadow-lg dark:bg-zinc-900")}>
