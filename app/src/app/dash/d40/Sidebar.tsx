...
import { Check, ChevronsUpDown, Radio, SlidersHorizontal, X } from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-11 shrink-0 items-center gap-2 px-4">
        <span className={cx("grid h-7 w-7 shrink-0 place-items-center rounded-[8px] text-white", "bg-indigo-600 dark:bg-indigo-500")}>
          <Radio size={16} aria-hidden="true" strokeWidth={2.25} />
        </span>
