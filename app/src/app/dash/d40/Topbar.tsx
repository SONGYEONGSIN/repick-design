...
const NOTIFICATIONS = [
  { id: "n1", text: "checkout-api rolled back after a failed deploy — recovered in 34 min.", time: "2h ago" },
  { id: "n2", text: "Change failure rate crossed 8% for payments-worker this week.", time: "6h ago" },
  { id: "n3", text: "Weekly reliability digest is ready for Orbital Platform.", time: "1d ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white dark:bg-zinc-950")}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search deploys, services, days</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-indigo-600 dark:bg-indigo-400" aria-hidden="true" />
          </button>
          {notifOpen ? (
