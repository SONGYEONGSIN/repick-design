...
const NOTIFICATIONS = [
  { id: "n1", text: "RT-410 (Mapo) fell behind schedule — now delayed", time: "4m ago" },
  { id: "n2", text: "Do-yun Kang closed out RT-414 with 6/6 stops", time: "22m ago" },
  { id: "n3", text: "Weekly dispatch digest is ready", time: "1h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search routes, drivers, zones</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-blue-400" aria-hidden="true" />
