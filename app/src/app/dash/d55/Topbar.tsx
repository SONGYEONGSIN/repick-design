...
const NOTIFICATIONS = [
  { id: "n1", text: "Anchor Systems crossed $50k in trailing 30-day volume", time: "12m ago" },
  { id: "n2", text: "Dispute opened on Vertex Manufacturing — $1,240", time: "1h ago" },
  { id: "n3", text: "Weekly payout batch for 6 accounts is ready to review", time: "4h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search merchant accounts</span>
            ...
            <div role="menu" aria-label="Account" className={cx("absolute right-0 top-full z-40 mt-2 w-60 rounded-xl border p-1", BORDER, PANEL_BG, "shadow-xl shadow-zinc-900/10")}>
              ...
              <div className="p-1">
                {[
                  ...
                  { label: "Payments documentation", Icon: HelpCircle },
