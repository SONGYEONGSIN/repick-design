  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-11 shrink-0 items-center gap-2 px-4">
        <span className="grid h-7 w-7 shrink-0 place-items-center rounded-[9px] bg-violet-700 text-white">
          <BRAND.Icon size={16} aria-hidden="true" strokeWidth={2.25} />
        </span>
        {/* Display typeface assignment for this round: wide grotesk-style latin face on the
            wordmark only — Korean and body copy never leave Pretendard. */}
