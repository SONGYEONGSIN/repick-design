        ...
        <div className="border-t border-zinc-100 p-3">
          ...
          <div className="flex items-center gap-2.5 rounded-lg px-2 py-2">
            ...
            <button
              type="button"
              aria-label="Settings"
              className="inline-flex h-11 w-11 items-center justify-center rounded-lg text-zinc-500 hover:bg-zinc-100 hover:text-zinc-700 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none"
            >
