  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b border-zinc-200 bg-white/95 px-4 backdrop-blur-sm sm:px-6">
      <button
        ...
        aria-label="메뉴 열기"
        className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-lg text-zinc-500 hover:bg-zinc-100 hover:text-zinc-900 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none lg:hidden"
      >
      ...
      >
        ...
        <span className="truncate">거래, 고객사, 담당자 검색…</span>
      ...
      <div className="ml-auto flex shrink-0 items-center gap-2">
        <button
          type="button"
          className="hidden h-11 items-center gap-1.5 rounded-lg bg-blue-600 px-3 text-sm font-medium text-white hover:bg-blue-700 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none sm:inline-flex"
        >
  ...
  return (
    <div className="relative">
      <button
        ...
        aria-expanded={open}
        aria-label="알림 3개 열기"
        className="relative inline-flex h-11 w-11 items-center justify-center rounded-lg text-zinc-500 hover:bg-zinc-100 hover:text-zinc-900 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:outline-none"
      >
      ...
      {open ? (
        ...
        >
          <p className="px-2 py-1.5 text-[11px] font-semibold tracking-wide text-zinc-400 uppercase">알림 3개</p>
          <ul className="space-y-0.5">
            <li className="rounded-lg px-2 py-2 text-sm text-zinc-700 hover:bg-zinc-50">
              <span className="font-medium text-zinc-900">밀레니엄리테일</span> 협상 단계로 이동했습니다.
            </li>
            <li className="rounded-lg px-2 py-2 text-sm text-zinc-700 hover:bg-zinc-50">
              <span className="font-medium text-zinc-900">코어페이먼츠</span> 마감이 3일 남았습니다.
            </li>
            <li className="rounded-lg px-2 py-2 text-sm text-zinc-700 hover:bg-zinc-50">
              <span className="font-medium text-zinc-900">이서연</span>님이 카이로스AI에 코멘트를 남겼습니다.
            </li>
          </ul>
        </div>
      ) : null}
      ...
      {open ? (
        ...
        >
          ...
          <button
            role="menuitem"
            type="button"
            className="flex min-h-[44px] w-full items-center gap-2 rounded-lg px-2.5 text-sm text-zinc-700 hover:bg-zinc-100 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
          >
          ...
          <button
            role="menuitem"
            type="button"
            className="flex min-h-[44px] w-full items-center gap-2 rounded-lg px-2.5 text-sm text-rose-600 hover:bg-rose-50 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
          >
