      ...
      {open ? (
        ...
        >
          ...
          <ul className="space-y-0.5">
            ...
            <li className="rounded-lg px-2 py-2 text-sm text-zinc-700 hover:bg-zinc-50">
              <span className="font-medium text-zinc-900">Core Payments</span> closes in 3 days.
            </li>
            <li className="rounded-lg px-2 py-2 text-sm text-zinc-700 hover:bg-zinc-50">
              <span className="font-medium text-zinc-900">Seoyeon Lee</span> left a comment on Kairos AI.
            </li>
          </ul>
        </div>
      ) : null}
