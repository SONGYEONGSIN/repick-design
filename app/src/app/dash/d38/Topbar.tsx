...
import { Bell, HelpCircle, LogOut, Menu, Search, Settings, Siren } from "lucide-react";
...
const NOTIFICATIONS = [
  { id: "n1", text: "INC-1042 paged you as primary on-call for api-gateway.", time: "3m ago" },
  { id: "n2", text: "Elena Voss acknowledged INC-1041 (billing-worker retry storm).", time: "44m ago" },
  { id: "n3", text: "Your Thursday on-call shift starts at 12:00 — swap window closes in 2h.", time: "1h ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-zinc-950")}>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        <button
          type="button"
          className={cx("hidden h-11 items-center gap-1.5 rounded-lg px-3.5 text-sm font-medium sm:inline-flex", "bg-teal-500 text-zinc-950 hover:bg-teal-400 active:bg-teal-600", TRANSITION, FOCUS_RING)}
        >
        ...
        <div ref={notifRef} className="relative">
          ...
          {notifOpen ? (
            <div role="menu" aria-label="Notifications" className={cx("absolute right-0 top-full z-40 mt-2 w-80 max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border", BORDER, "bg-zinc-900 shadow-lg shadow-black/40")}>
