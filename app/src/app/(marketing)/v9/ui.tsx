...
import AnnotationScan from "./AnnotationScan";
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            >
              Nothing escapes
              <br />
              <span className="text-[#6E56CF]">the scan.</span>
            </motion.h1>
            ...
            >
              Before a listing reaches you, our AI walks the garment pixel by
              pixel — annotating the weave, the seams, the tag, and the wear,
              the way an inspector would. Every pin below is a real finding,
              not a decoration.
            </motion.p>
          ...
          {/* right: annotated product photo + evidence panel */}
          <motion.div
        ...
        <div className="mx-auto w-full max-w-[1120px] px-5 py-28 sm:px-8">
          ...
          >
            ...
            <p className="mt-6 max-w-lg text-base font-normal leading-[1.6] text-[#A1A1AA]">
              ...
              listing we surface arrives already scanned and pinned — five
              checks on file, nothing left to take on faith.
            </p>
            <div className="mt-9">
