 ...
 * verified-seller badge, and the before/after discount are all part of the
 * card's resting state (never hover- or focus-only), per the brief's hard
 * rule. Hover/focus adds a small, purely additive lift + image scale on top
 * of that always-visible baseline — a fourth, distinct interaction.
 */
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="max-w-2xl"
      >
        <p className={cx(EYEBROW, "text-[#a894f7]")}>Fig. 02 — Already annotated</p>
        <h2 className="mt-4 text-[clamp(1.9rem,5vw,2.75rem)] font-extrabold leading-[1.08] tracking-[-0.02em] text-white">
          Four listings, scanned before you ever see them.
        </h2>
        <p className="mt-5 text-base font-normal leading-[1.6] text-[#A1A1AA]">
          ...
          seller verification at rest — no hover required to see the proof.
        </p>
      </motion.div>
