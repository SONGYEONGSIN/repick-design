        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-500">
                Ridgeline · Northwind SaaS — ARR bridge and account-level movements.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-12">
            <section
              ...
              className="rounded-xl focus:outline focus:outline-2 focus:outline-offset-4 focus:outline-cyan-600 xl:col-span-8"
            >
              <Card>
            ...
            <section id="category-spotlight" className="xl:col-span-4">
