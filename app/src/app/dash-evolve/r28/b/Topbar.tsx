  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span className="hidden text-sm font-medium text-zinc-700 sm:inline">Mina</span>
      ...
      {open && (
        ...
        >
          <div className="border-b border-zinc-100 px-3.5 py-2.5">
            <p className="truncate text-sm font-medium text-zinc-900">Mina Cho</p>
            <p className="truncate text-xs text-zinc-500">RevOps Lead · Northwind SaaS</p>
          </div>
          <button
            type="button"
            role="menuitem"
