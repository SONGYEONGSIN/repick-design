...
const NOTIFICATIONS = [
  { id: "n1", text: "Locksley Data Centers dropped into the At Risk quadrant — health fell 12 pts this week.", time: "22m ago" },
  { id: "n2", text: "10 renewals are due within the next 60 days across the Enterprise Pod.", time: "3h ago" },
  { id: "n3", text: "Fennimore Aerospace logged a new Champions-tier NPS promoter response.", time: "7h ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white")}>
      ...
      >
        ...
        <span className="hidden truncate sm:inline">Jump to an account…</span>
