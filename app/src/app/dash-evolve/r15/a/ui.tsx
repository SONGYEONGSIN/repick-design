...
import { BORDER, CARD, FOCUS_RING, HEALTH_LABEL, HEALTH_TONE, TEXT_CAPTION, TEXT_PRIMARY, TRANSITION, cx } from "./tokens";
...
export function SegmentedControl<T extends string>({
  ...
  return (
    <div role="radiogroup" aria-label={ariaLabel} className={cx("inline-flex items-center gap-0.5 rounded-lg border p-0.5", BORDER, "bg-zinc-900/60")}>
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={cx(
              ...
              TRANSITION,
              FOCUS_RING,
              active ? cx("bg-zinc-800", TEXT_PRIMARY, "font-semibold") : cx(TEXT_CAPTION, "hover:text-zinc-50"),
            )}
          >
