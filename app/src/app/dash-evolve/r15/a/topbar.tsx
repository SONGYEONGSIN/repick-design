...
import { Avatar, useOutsideClose } from "./ui";
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-zinc-950")}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search services, owners, tiers</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          <button
            ...
            className={cx("relative grid h-11 w-11 place-items-center rounded-full border", BORDER, "bg-zinc-900/60", HOVER_ACTIVE_BG, TRANSITION, FOCUS_RING)}
          >
        ...
        <div ref={userRef} className="relative">
          <button
            ...
            className={cx("flex h-11 items-center gap-2 rounded-full border pl-1 pr-2", BORDER, "bg-zinc-900/60", HOVER_ACTIVE_BG, TRANSITION, FOCUS_RING)}
          >
