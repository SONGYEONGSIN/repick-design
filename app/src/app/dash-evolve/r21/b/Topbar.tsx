...
const NOTIFICATIONS = [
  { id: "n1", text: "VR-0111 escalated to legal review", time: "12m ago" },
  { id: "n2", text: "Owen Fen closed VR-0119", time: "1h ago" },
  { id: "n3", text: "Weekly risk digest is ready", time: "3h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search cases</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-rose-600" aria-hidden="true" />
