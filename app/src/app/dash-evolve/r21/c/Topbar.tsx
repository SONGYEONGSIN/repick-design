...
const NOTIFICATIONS = [
  { id: "n1", text: "Ridge Trail Jacket — Slate, XL fell below reorder point", time: "8m ago" },
  { id: "n2", text: "PO #4821 confirmed for East DC, arrives in 12 days", time: "1h ago" },
  { id: "n3", text: "Weekly forecast accuracy report is ready", time: "4h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search SKUs</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-teal-500" aria-hidden="true" />
        ...
        <div ref={userRef} className="relative">
          ...
          >
            <Image
              ...
              width={30}
              height={30}
              className="h-[30px] w-[30px] shrink-0 rounded-full bg-white/5 object-cover"
            />
            ...
            <div role="menu" aria-label="Account" className={cx("absolute right-0 top-full z-40 mt-2 w-60 rounded-xl border p-1", BORDER, PANEL_BG, "shadow-xl shadow-black/40")}>
              ...
              <div className="p-1">
                {[
                  ...
                  { label: "Forecast methodology", Icon: HelpCircle },
