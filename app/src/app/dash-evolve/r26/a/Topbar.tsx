...
import { Bell, CircleQuestionMark, FileDown, LogOut, Menu, Search, Settings } from "lucide-react";
...
const NOTIFICATIONS = [
  { id: "n1", text: "Dock 4 — Zone B crossed 46 min out of band", time: "6m ago" },
  { id: "n2", text: "Trailer bay 7 excursion acknowledged by Marco Vidal", time: "34m ago" },
  { id: "n3", text: "Weekly network digest is ready", time: "2h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search zones and facilities</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        <button type="button" className={cx("hidden h-11 items-center gap-1.5 rounded-lg px-3.5 text-sm font-semibold sm:inline-flex", ACCENT_SOLID, TRANSITION, FOCUS)}>
          <FileDown size={15} aria-hidden="true" strokeWidth={2.25} />
          Export report
        </button>
            ...
            <div role="menu" aria-label="Account" className={cx("absolute right-0 top-full z-40 mt-2 w-60 rounded-xl border p-1", BORDER, PANEL_BG, "shadow-xl shadow-zinc-900/10")}>
              ...
              <div className="p-1">
                {[
                  ...
                  { label: "Runbook docs", Icon: CircleQuestionMark },
