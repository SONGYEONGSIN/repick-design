...
import { Bell, ClipboardCheck, HelpCircle, LogOut, Menu, Plus, Search, Settings } from "lucide-react";
...
const NOTIFICATIONS = [
  { id: "n1", text: "Northfield Alloys flagged — 3 severity spikes this week", time: "18m ago" },
  { id: "n2", text: "Kessler Optics finding KO-0142 needs sign-off", time: "1h ago" },
  { id: "n3", text: "Weekly quality digest is ready", time: "3h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search suppliers</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-violet-600" aria-hidden="true" />
            ...
            <div role="menu" aria-label="Account" className={cx("absolute right-0 top-full z-40 mt-2 w-60 rounded-xl border p-1", BORDER, PANEL_BG, "shadow-xl shadow-zinc-900/10")}>
              ...
              <div className="p-1">
                {[
                  ...
                  { label: "Scoring rubric", Icon: HelpCircle },
                  { label: "Inspection templates", Icon: ClipboardCheck },
