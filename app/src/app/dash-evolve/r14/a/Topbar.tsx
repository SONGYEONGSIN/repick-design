...
const NOTIFICATIONS = [
  { id: "n1", text: "HB-1024 (Vantree Logistics) was escalated — SSO redirect loop, 12 min left on the urgent SLA.", time: "6m ago" },
  { id: "n2", text: "Fenwick & Cole's account health dropped below the 90 threshold this week.", time: "3h ago" },
  { id: "n3", text: "Your weekly SLA compliance digest is ready.", time: "1d ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white")}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search tickets, customers, agents</span>
