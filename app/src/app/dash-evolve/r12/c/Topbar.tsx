...
import { Bell, HelpCircle, LogOut, Menu, Rocket, Search, Settings } from "lucide-react";
...
const NOTIFICATIONS = [
  { id: "n1", text: "Q5 “Setup ease” drop-off crossed 20% — 402 respondents left without answering.", time: "1h ago" },
  { id: "n2", text: "148 new responses came in for Onboarding Pulse Survey overnight.", time: "6h ago" },
  { id: "n3", text: "Your weekly survey-health digest is ready to review.", time: "1d ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white dark:bg-zinc-950")}>
      ...
      >
        ...
        <span className="hidden truncate sm:inline">Jump to a question, or add one…</span>
