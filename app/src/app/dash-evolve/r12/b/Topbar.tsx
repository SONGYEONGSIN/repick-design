...
import { Bell, FilePlus2, HelpCircle, LogOut, Menu, Search, Settings } from "lucide-react";
...
const NOTIFICATIONS = [
  { id: "n1", text: "Corvid Analytics Corp. returned a new markup on Limitation of Liability.", time: "1h ago" },
  { id: "n2", text: "Falkirk Energy Systems MSA is ready for countersignature.", time: "4h ago" },
  { id: "n3", text: "Fenwick & Cole Partners NDA expires in 12 days — renewal not yet started.", time: "1d ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white dark:bg-zinc-950")}>
      ...
      >
        ...
        <span className="hidden truncate sm:inline">Search contracts, counterparties…</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-sky-700 dark:bg-sky-400" aria-hidden="true" />
          </button>
          {notifOpen ? (
            <div role="menu" aria-label="Notifications" className={cx("absolute right-0 top-full z-40 mt-2 w-80 max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border", BORDER, "bg-white dark:bg-zinc-900 shadow-lg")}>
        ...
        <div ref={userRef} className="relative">
          ...
          {userOpen ? (
            <div role="menu" aria-label="Account" className={cx("absolute right-0 top-full z-40 mt-2 w-60 overflow-hidden rounded-xl border p-1", BORDER, "bg-white dark:bg-zinc-900 shadow-lg")}>
