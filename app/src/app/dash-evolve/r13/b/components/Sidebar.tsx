...
import { BRAND, CURRENT_USER, NAV_SECTIONS, unsplashAvatar, WORKSPACES } from "../data";
import { ACCENT_SUBTLE, ACCENT_TEXT, BORDER, FOCUS_RING, HOVER_ACTIVE_BG, TEXT_CAPTION, TEXT_PRIMARY, TRANSITION, cx } from "../tokens";
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-11 shrink-0 items-center gap-2 px-4">
        <span className="grid h-7 w-7 shrink-0 place-items-center rounded-[8px] bg-cyan-400 text-zinc-950">
    ...
    <>
      ...
      {mobileOpen ? (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className={cx("absolute inset-y-0 left-0 w-72 max-w-[85vw] border-r shadow-lg shadow-black/40", BORDER, "bg-zinc-950")}>
