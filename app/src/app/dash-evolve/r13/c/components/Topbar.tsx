...
import { Bell, LogOut, Menu, Plus, Search, Settings2 } from "lucide-react";
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-zinc-950")}>
      ...
      <button
        ...
        aria-label="Search posts, channels, days…"
      ...
      >
        ...
        <span aria-hidden="true" className="hidden truncate sm:inline">Search posts, channels, days…</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-orange-400" aria-hidden="true" />
          </button>
          {notifOpen ? (
            <div role="menu" aria-label="Notifications" className={cx("absolute right-0 top-full z-40 mt-2 w-80 max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border", BORDER, "bg-zinc-900 shadow-lg")}>
        ...
        <div ref={userRef} className="relative">
          ...
          {userOpen ? (
            <div role="menu" aria-label="Account" className={cx("absolute right-0 top-full z-40 mt-2 w-60 overflow-hidden rounded-xl border p-1", BORDER, "bg-zinc-900 shadow-lg")}>
