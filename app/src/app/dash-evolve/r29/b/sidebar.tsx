...
import { Rss, FolderSearch2, Users, Lock, FileClock, Settings, Shield, X } from "lucide-react";
import { Avatar, FOCUS_RING, FOCUS_RING_FULL } from "./ui";

const NAV = [
  { label: "Live Feed", icon: Rss, active: true },
  { label: "Investigations", icon: FolderSearch2, active: false },
  { label: "Accounts & Roles", icon: Users, active: false },
  { label: "Access Policies", icon: Lock, active: false },
  { label: "Audit Log", icon: FileClock, active: false },
];
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-16 items-center gap-2.5 border-b border-zinc-200 px-5">
        ...
        <span className="text-lg font-bold text-zinc-900">Warden</span>
        {onClose && (
          <button
            type="button"
            onClick={onClose}
      ...
      <div className="border-b border-zinc-200 px-3 py-3">
        ...
        >
          <span className="min-w-0">
            ...
            <span className="block truncate text-sm font-bold text-zinc-900">Northwind Cloud — Production</span>
          </span>
        </button>
      </div>
      ...
      <div className="border-t border-zinc-200 p-3">
        ...
        <div className="mt-1 flex items-center gap-2.5 rounded-lg px-3 py-2">
          <Avatar initials="PC" size={32} />
          <span className="min-w-0">
            <span className="block truncate text-sm font-medium text-zinc-900">Priya Chen</span>
            <span className="block truncate text-xs font-normal text-zinc-500">Trust &amp; Safety Lead</span>
          </span>
        </div>
      </div>
    </div>
