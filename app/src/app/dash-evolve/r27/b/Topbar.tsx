...
const NOTIFICATIONS = [
  { id: "n1", text: "us-east-1 On-Demand Instances crossed +40% vs. prior period", time: "6m ago" },
  { id: "n2", text: "Jordan Ames acknowledged the eu-west-1 transfer spike", time: "24m ago" },
  { id: "n3", text: "Monthly cost root-cause digest is ready", time: "2h ago" },
];
  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search regions, services, SKUs&hellip;</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-blue-600" aria-hidden="true" />
