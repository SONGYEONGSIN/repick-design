  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-11 shrink-0 items-center gap-2 px-4">
        <span className="grid h-7 w-7 shrink-0 place-items-center rounded-[9px] bg-amber-400 text-zinc-950">
    ...
    <>
      ...
      {mobileOpen ? (
        <div className="fixed inset-0 z-50 lg:hidden">
          {/* Pointer-only close affordance, deliberately out of the tab order — the explicit "X"
              button below is the keyboard path, so this never needs its own focus treatment. */}
          <div aria-hidden="true" onClick={onCloseMobile} className="absolute inset-0 bg-black/60" />
