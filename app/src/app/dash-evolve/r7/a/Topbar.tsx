...
const NOTIFICATIONS = [
  { id: "n1", text: "Wavelength 계정 헬스가 45점 아래로 떨어졌습니다.", time: "4분 전" },
  { id: "n2", text: "Meridian이 Retained → Expanded 단계로 이동했습니다.", time: "26분 전" },
  { id: "n3", text: "Cobalt의 결제가 2회 연속 실패했습니다.", time: "3시간 전" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white dark:bg-zinc-950")}>
      ...
      >
        ...
        <span className="hidden truncate sm:inline">계정, 담당자, 단계 검색</span>
        <span
          aria-hidden="true"
