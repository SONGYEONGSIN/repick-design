...
import { BORDER, FOCUS_RING, NUM, TEXT_CAPTION, TEXT_PRIMARY, TRANSITION, cx, type StateMeta, type Tone, TONE } from "./tokens";
...
/** 상태 배지(색 + 텍스트 병행) — 신뢰도(RELIABILITY_META)·지연(LATENCY_META) 공용, meta를 직접 받는다. */
...
/** 수평 진행률 바 — 요청량/오류율 등 공용 시각화. value/max 0 이상, 색+수치 병행. */
...
/** 결정론 요청량 추이 스파크라인 — 라인 + 은은한 면적 + 종점. 좌표 소수 2자리. */
