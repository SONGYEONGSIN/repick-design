...
const NOTIFICATIONS = [
  { id: "n1", text: "payments-svc weekly error budget exhausted — release freeze active.", time: "2h ago" },
  { id: "n2", text: "checkout-api p99 latency back within target after INC-482 rollback.", time: "5h ago" },
  { id: "n3", text: "search-api CPU saturation crossed 90% for the third time this week.", time: "1d ago" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white dark:bg-zinc-950")}>
      ...
      >
        ...
        <span className="hidden truncate sm:inline">Search services, incidents</span>
        <span
          aria-hidden="true"
