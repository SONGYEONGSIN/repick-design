/**
 * Redline — 라우트 스코프 디자인 토큰. 전역 테마를 건드리지 않고 이 라우트 안에서만 쓰는 클래스 상수.
 ...
 * 강조 1색 = sky (UI 크롬: 버튼/포커스링/활성 네비). 게이지 존/배지 톤은 TONE(아래)이 담당 — 색+텍스트 항상 병행.
 */
...
/* 상태/존 톤 — 게이지 존, 배지, 심각도 등에 사용. 색만으로 구분하지 않고 항상 아이콘/텍스트 병행. */
