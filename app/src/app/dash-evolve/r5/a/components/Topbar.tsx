...
const NOTIFICATIONS = [
  { id: "n1", text: "USD/JPY 헤지 비율이 40% 아래로 떨어졌습니다.", time: "12분 전" },
  { id: "n2", text: "EUR/KRW 포지션 PX-3009가 승인 대기 중입니다.", time: "1시간 전" },
  { id: "n3", text: "USD/SGD 정산이 오늘 완료되었습니다.", time: "3시간 전" },
];
  ...
  return (
    <header className={cx("flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, "bg-white dark:bg-zinc-950")}>
      ...
      >
        ...
        <span className="hidden truncate sm:inline">종목, 포지션, 법인 검색</span>
        <span
          aria-hidden="true"
