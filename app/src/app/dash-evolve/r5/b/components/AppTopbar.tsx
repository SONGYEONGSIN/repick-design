...
import { CURRENT_AGENT_ID, WORKSPACE, agentById } from "../lib/data";

const NOTIFICATIONS = [
  { id: "n1", text: "Malik Osei sent a new message on \"App login issue\".", time: "12m ago" },
  { id: "n2", text: "Tomas Reyes opened an urgent billing conversation.", time: "1h ago" },
  { id: "n3", text: "Priya Anand resolved \"Price match request for rain shell\".", time: "3h ago" },
];

/**
 * Global app-shell top bar. Every interactive control here — the ⌘K trigger,
 * the primary action button, and each icon button — is h-11 (44px), not just
 * the h-11 header container, per the header-control sizing rule.
 */
  ...
  return (
    <header className="flex h-11 shrink-0 items-center gap-2 border-b border-zinc-200 bg-white px-3 sm:px-4">
      ...
      <div className="hidden min-w-0 flex-col leading-tight sm:flex">
        ...
        <span className="truncate text-[11px] text-zinc-500">Shared inbox</span>
      </div>
      ...
      >
        ...
        <span className="hidden truncate sm:inline">Search conversations, customers…</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div className="relative" ref={userRef}>
          ...
          >
            <Avatar avatarId={you.avatarId} name={you.name} size={26} />
          </button>
          {userOpen ? (
            <div
              role="menu"
