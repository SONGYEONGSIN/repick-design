...
export function Segmented<T extends string | number>({ options, value, onChange, ariaLabel }: { options: { id: T; label: string }[]; value: T; onChange: (id: T) => void; ariaLabel: string }) {
  return (
        ...
        return (
          <button
            ...
            className={cx(
              ...
              TRANSITION,
              FOCUS,
              active ? "bg-blue-700 font-semibold text-white" : cx("font-medium", TEXT_MUTED, "hover:bg-white/[0.06] hover:text-zinc-50"),
            )}
          >
            {opt.label}
          </button>
