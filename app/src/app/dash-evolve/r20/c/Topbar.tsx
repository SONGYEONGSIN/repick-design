  ...
  return (
    <header className={cx("sticky top-0 z-30 flex h-11 shrink-0 items-center gap-2 border-b px-3 sm:px-4", BORDER, PANEL_BG)}>
      ...
      >
        ...
        <span className="sr-only truncate sm:not-sr-only sm:inline">Search services</span>
      ...
      <div className="ml-auto flex items-center gap-1.5">
        ...
        <div ref={notifRef} className="relative">
          ...
          >
            ...
            <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-emerald-500" aria-hidden="true" />
