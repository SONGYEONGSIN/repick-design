...
export default function LandingClient() {
  ...
  return (
    <main className="min-h-screen bg-[#0B0B0F] text-white antialiased">
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            >
              Not a guess.
              <br />
              <span className="text-[#6E56CF]">A verdict.</span>
            </motion.h1>
            ...
            >
              repick&rsquo;s AI doesn&rsquo;t just suggest secondhand finds —
              it appraises them. Every listing ships with a match score, a
              condition grade, a seller verification, and a price verdict,
              filed and ready to check.
            </motion.p>
      ...
      {/* social proof — stat band + notarized pull quote */}
        ...
        <div className="mx-auto w-full max-w-[1120px] px-5 py-28 sm:px-8">
          ...
          >
            ...
            <p className="mt-6 max-w-lg text-base font-normal leading-[1.6] text-[#A1A1AA]">
              ...
              listing we surface arrives with its appraisal already on
              file — nothing to take on faith.
            </p>
            <div className="mt-9">
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto flex w-full max-w-[1120px] flex-col gap-2 px-5 py-10 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          ...
          <span className="text-xs font-normal text-[#A1A1AA]">
            AI-certified secondhand · 2026 REPICK
          </span>
        </div>
      </footer>
    </main>
