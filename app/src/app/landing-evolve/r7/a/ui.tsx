        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            >
              New matches,
              <br />
              <span className="text-[#6E56CF]">already posted.</span>
            </motion.h1>
            ...
            >
              repick&rsquo;s AI keeps a running board of listings pulled from
              your taste profile. Switch categories and the board re-scans —
              real rows, match score and price stamped on before you click.
            </motion.p>
            ...
            >
              ...
              <span className="text-xs font-normal text-[#A1A1AA]">
                60-second taste profile · no card required
              </span>
            </motion.div>
          ...
          {/* right: the split-flap board itself */}
          <motion.div
      ...
      <section id="cta" className="border-t border-white/10">
        <div className="mx-auto w-full max-w-[1120px] px-5 py-28 sm:px-8">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <h2 className="text-[clamp(2rem,6.2vw,2.75rem)] font-extrabold leading-[1.05] tracking-[-0.02em] text-white lg:text-[clamp(2.4rem,5vw,3.6rem)]">
              Stop scrolling.
              <br />
            ...
            <p className="mt-6 max-w-lg text-base font-normal leading-[1.6] text-[#A1A1AA]">
              ...
              listing that matters to you posts to your board with its
              score, grade, and price already stamped on.
            </p>
            <div className="mt-9">
