        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            >
              Five channels.
              <br />
              <span className="text-[#6E56CF]">One verdict, mixed.</span>
            </motion.h1>
            ...
            >
              repick&rsquo;s AI already scored this match before you arrived.
              Taste, size, budget, condition, and price are graded
              independently, then mixed into one number — select any channel
              to see exactly what it found.
            </motion.p>
        ...
        <div className="mx-auto w-full max-w-[1120px] px-5 py-28 sm:px-8">
          ...
          >
            ...
            <p className="mt-6 max-w-lg text-base font-normal leading-[1.6] text-[#A1A1AA]">
              Build your taste profile in a minute. From then on, every match
              we surface arrives with its five channels already scored —
