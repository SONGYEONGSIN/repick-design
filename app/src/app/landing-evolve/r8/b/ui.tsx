    ...
    <main className="min-h-screen bg-[#0B0B0F] text-white antialiased">
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            >
              ...
              Live weigh-in · Guess vs. evidence
            </motion.p>
            ...
            >
              Your gut feeling
              <br />
              <span className="text-[#6E56CF]">never stood a chance.</span>
            </motion.h1>
            ...
            >
              Set a generic listing on one side of the scale and your repick
              AI match on the other — match score, condition grade, verified
              seller, real discount. Evidence outweighs a guess, every time.
            </motion.p>
            ...
            >
              ...
              <span className="text-xs font-normal text-[#A1A1AA]">
                3 priorities · real recompute below
              </span>
            </motion.div>
          ...
          {/* right: the balance scale itself */}
          <motion.div
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto w-full max-w-[1120px] px-5 py-24 sm:px-8">
          ...
          >
            Fig. 04 — What tips in your favor
          </motion.p>
        ...
        <div className="mx-auto w-full max-w-[1120px] px-5 py-28 sm:px-8">
          ...
          >
            ...
            <p className="mt-6 max-w-lg text-base font-normal leading-[1.6] text-[#A1A1AA]">
              ...
              listing we surface already arrives on the heavier side of the
              scale — match score, grade, and proof on file.
            </p>
            <div className="mt-9">
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto flex w-full max-w-[1120px] flex-col gap-2 px-5 py-10 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          ...
          <span className="text-xs font-normal text-[#A1A1AA]">
            AI-weighed secondhand · 2026 REPICK
          </span>
        </div>
      </footer>
    </main>
